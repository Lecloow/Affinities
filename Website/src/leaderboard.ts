...
export class LeaderboardPage {
      ...
      <div class="page-wrapper">
        ...
        <header>
          <div class="page-header">
            ...
            <p class="greeting-text">🏆 Classement</p>
            ${user ? `<button class="logout-btn" onclick="logout()" aria-label="Se déconnecter">${logoutIcon}</button>` : '<div></div>'}
          </div>
  ...
  private renderLeaderboard(): void {
    ...
    rows += `<div class="leaderboard-update-time">Dernière mise à jour : ${timeStr}</div>`;
